...
source_csv_file = 'C:/Users/valentinosko/Downloads/Etoro_trade_reports_from_3rd_Feb_new2.csv'

df = pd.read_csv("C:/Users/valentinosko/Downloads/Etoro_trade_reports_from_3rd_Feb_new2.csv")
...
def insert_batch(batch):
    try:
        cursor.executemany("""
            INSERT INTO TradEcho_Reports_2 (
                SENDING_TIME,
                MSG_TYPE,
                VIRT_CLIENT_ID,
                FIRM_TRADE_ID,
